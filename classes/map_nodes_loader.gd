...
func _ready():
	fixed_nodes = load_folder("res://classes/fixed_nodes")
	random_nodes = load_folder("res://classes/random_nodes")
	print("scenes from folder \"classes/fixed_nodes\" \"classes/random_nodes\" has been loaded ")
